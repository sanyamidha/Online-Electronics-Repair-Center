...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-dark bg-danger pl-5 fixed-top">
    <a href="index.php" class="navbar-brand">OERC</a>
  ...
  <header class="jumbotron back-image" style="background-image: url(images/Banner1.jpg);">
    <div class="myclass mainHeading">
      <h1 class="text-uppercase text-danger font-weight-bold">Welcome to OERC</h1>
  ...
  <div class="container">
    ...
    <div class="jumbotron">
      <h3 class="text-center">OERC Services</h3>
      <p>
        OERC Services is one of the leading chain of multi-brand Electronics and Electrical service
        workshops offering
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Sanya Midha</h4>
              <p class="card-text"> 
              This site has been an outstanding asset and very helpful especially during the lockdown days where one can't step out to get their appliances repaired.
               </p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Agrim Sharma</h4>
              <p class="card-text">Overall Service is high quality and price is at least fair, I Would highly recommend to use this platform and get the most of it.</p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Tanisha Aggarwal</h4>
              <p class="card-text">
              I am very satisfied with the overall Service provided by the Online Electronics Repair Center. Looking forward for more features.
              </p>
            </div>
          </div>
        ...
        <div class="col-lg-3 col-sm-6">
          ...
          <div class="card shadow-lg mb-2">
            <div class="card-body text-center">
              ...
              <h4 class="card-title">Ishaan Jain</h4>
              <p class="card-text">
              I have been using this platform over one year period and never had any problems. The request procedure is very simple and doesn't required to invest much time.
              </p>
            </div>
          </div>
  ...
  <div class="container" id="Contact">
    ...
    <div class="row">
      ...
      <div class="col-md-4 text-center">
        ...
        OERC Pvt Ltd. <br>
        Upper Bazar, Rangreez Gali<br>
       Ranchi, <br>
       India <br>
        <a href="#" target="_blank">www.oesms.com</a> <br>

        <br><br>
        <strong>Ratu Road Branch:</strong> <br>
        OERC Pvt Ltd, <br>
        4/1 Krishna Nagar Colony,<br>
        Ranchi 834001 <br>
        <a href="#" target="_blank">www.oerc.com</a> <br>
    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Sanya Midha &copy; 2020.
          </small>
