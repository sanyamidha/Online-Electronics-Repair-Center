...
<div class="col-sm-4 mb-5">
  ...
  <?php 
 $sql = "SELECT request_id, request_info, request_desc, request_date FROM submitrequest_tb_new";
...
if(isset($_REQUEST['close'])){
  $sql = "DELETE FROM submitrequest_tb_new WHERE request_id = {$_REQUEST['id']}";
