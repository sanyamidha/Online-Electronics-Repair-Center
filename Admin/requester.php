 ...
 echo '<table class="table">
  ...
  while($row = $result->fetch_assoc()){
   echo '<tr>';
    ...
    echo '<td><form action="#" method="POST" class="d-inline"> <input type="hidden" name="id" value='. $row["r_login_id"] .'><button type="submit" class="btn btn-info mr-3" name="view" value="View"><i class="fas fa-pen"></i></button></form>  
